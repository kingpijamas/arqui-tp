...
void help_cmd(int argc, char ** args){
	...
	__print_help_line("putc    ",
		"Test for the 'putc' function from <stdio.h>");
	__print_help_line("printf  ",
		"Test for the 'printf' function from <stdio.h>");
	__print_help_line("getc    ",
		"Test for the 'getc' function from <stdio.h>");
	__print_help_line("scanf   ",
		"Test for the 'scanf' function from <stdio.h>");
	__print_help_line("abrirCD ",
		"Opens the CD reader");
	__print_help_line("cerrarCD",
		"Closes the CD reader");
	__print_help_line("infoCD  ",
		"Displays the size of the current CD in the CD reader");
	__print_help_line("logo    ",
		"Prints the logo");
	__print_help_line("help    ",
